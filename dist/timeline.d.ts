...
export declare function getPieceGroupId(piece: IBlueprintPieceDB | string): string;
export declare function getPartFirstObjectId(part: IBlueprintPartInstance | string): string;
export declare function getPieceFirstObjectId(piece: IBlueprintPieceDB | string): string;
